    ...
    data.forEach(datum => {
        ...
        for (const [label, type] of Object.entries(datum.fields)) {
            if (Array.isArray(type)) {
                ...
                htmlBody += `<div class="is-flex"><div class="mt-2 mx-3" style="width: 330px;"><label style="font-size: large;">${label} :</label></div> <div class="is-flex is-justify-content-center"><div class="select custom-select"><select style="width: 240px;">`;
                ...
                htmlBody += `<div class="is-flex"><div class="mt-2 mx-3 wid"><label style="font-size: large;">${label} :</label></div> <div class="is-flex is-justify-content-center wid"><input class="input custom-input w" placeholder="${label}" type="${type}"></div></div> <br>`;
            }
        }
        htmlBody += "</div></div><br>";
    });
